...
interface AdminDisciplineDataProps {
...
interface UpdateDisciplineVariables {
  id: string;
  adminComments: string;
}
...
const AdminDisciplineData: React.FC<AdminDisciplineDataProps> = ({
  discipline,
  refetch,
}) => {
...
export default AdminDisciplineData;
