...
interface EditStudentRowProps {
  ...
  studentList: Student[];
  updateChromebookAssignment: any;
}
...
interface ChromebookAssignmentsDataProps {
  assignments: Assignment[];
}

export default function ChromebookAssignmentsData({
  assignments,
}: ChromebookAssignmentsDataProps) {
  ...
  const teacherList = useMemo(() => {
    ...
    return (
      teachersData?.users?.sort((a: Teacher, b: Teacher) =>
  ...
  const studentList = useMemo(() => {
    ...
    return (
      studentsData?.users
        .filter(
          (student: Student) => !studentsWithAssignments.includes(student.id),
        )
