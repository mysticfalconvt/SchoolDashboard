...
interface StudentPbisCardsPerCollectionProps {
  cards: PbisCard[];
}

export default function StudentPbisCardsPerCollection({
  cards,
}: StudentPbisCardsPerCollectionProps) {
  const cardsByWeek = cards.reduce(
    (acc, card) => {
